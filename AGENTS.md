...
- Primary workflow: `./.agents/workflows/primary-workflow.md`
- Development rules: `./.agents/workflows/development-rules.md`
- Orchestration protocols: `./.agents/workflows/orchestration-protocol.md`
- Documentation management: `./.agents/workflows/documentation-management.md`
- And other workflows: `./.agents/workflows/*`
...
Skills are located in `.agents/skills/`. Each skill folder contains a `SKILL.md` with instructions, and may include additional scripts, examples, or resources.

### How to use skills

1. **Scan the catalog** — At the start of every conversation, list `.agents/skills/*/SKILL.md` to discover available skills.

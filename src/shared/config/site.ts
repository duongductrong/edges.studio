export const SITE_NAME = 'edges.studio'
export const SITE_TAGLINE = 'Build Once. Ship Beautifully.'
...
export const CTA_PRIMARY_LABEL = 'Explore our apps'

export const CTA_SECONDARY_LINE1 = 'Latest release: Snapzy'
export const CTA_SECONDARY_LINE2 = 'v1.0.0 is available now'

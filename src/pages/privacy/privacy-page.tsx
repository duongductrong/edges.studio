        ...
        <div className="space-y-10 text-[15px] leading-relaxed text-foreground">
          ...
          <section>
            ...
            <p>
              ...
              Privacy Policy applies to the edges.studio website and all
              products and services developed and published by edges.studio.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <strong>locally on your device</strong>. We do not upload,
              transmit, or have access to your captured content.
            </p>
            ...
            <ul className="mt-3 list-inside list-disc space-y-1.5 text-muted-foreground">
              <li>
                Pages visited, referring URL, browser type, and device
                information
              </li>
          ...
          <section>
            ...
            <p>
              ...
              privacy- focused analytics providers) that collect anonymised
              data. These services have their own privacy policies governing the
          ...
          <section>
            ...
            <p>
              Website analytics data is retained in an aggregated, anonymised
              form and does not contain personally identifiable information. If
              you contact us via email, we retain your message only as long as
          ...
          <section>
            ...
            <p>
              Our products and services are not directed at children under the
          ...
          <section>
            ...
            <p>
              ...
              be posted on this page with a revised date. We encourage you to
